...
URL = "https://www.psdevwiki.com/ps3/index.php?title=PS1_Classics_Emulator_Compatibility_List&action=raw"

PLAYABILITY_TAGS = {
    "{{ps1classic}}": "PS1 Classic",
    "{{playable}}": "Playable",
...
def parse_stats(html):
    ...
    for row in rows:
        ...
        # 1. ps1 classic gets priority
        if "{{ps1classic}}" in compatibility_info:
            stats["PS1 Classic"] += 1
            continue
            
        # 2. for other games, use worst status
        worst_status = None
